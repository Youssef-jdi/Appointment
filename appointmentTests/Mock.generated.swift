...
open class AppErrorMock: AppError, Mock {
    ...
    public var description: String {
		get {	invocations.append(.p_description_get); return __p_description ?? givenGetterValue(.p_description_get, "AppErrorMock - stub value for description was not defined") }
		@available(*, deprecated, message: "Using setters on readonly variables is deprecated, and will be removed in 3.1. Use Given to define stubbed property return value.")
...
open class AuthManagerProtocolMock: AuthManagerProtocol, Mock {
    ...
    open func loginWithLinkedin(token: String, completion: @escaping ((AuthResult<LoginResponse>) -> Void)) {
        addInvocation(.m_loginWithLinkedin__token_tokencompletion_completion(Parameter<String>.value(`token`), Parameter<(AuthResult<LoginResponse>) -> Void>.value(`completion`)))
		let perform = methodPerformValue(.m_loginWithLinkedin__token_tokencompletion_completion(Parameter<String>.value(`token`), Parameter<(AuthResult<LoginResponse>) -> Void>.value(`completion`))) as? (String, @escaping ((AuthResult<LoginResponse>) -> Void)) -> Void
    ...
    fileprivate enum MethodType {
        ...
        case m_loginWithLinkedin__token_tokencompletion_completion(Parameter<String>, Parameter<(AuthResult<LoginResponse>) -> Void>)
        ...
        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Bool {
            ...
            case (.m_login__email_emailpassword_passwordcompletion_completion(let lhsEmail, let lhsPassword, let lhsCompletion), .m_login__email_emailpassword_passwordcompletion_completion(let rhsEmail, let rhsPassword, let rhsCompletion)):
                ...
                return true 
            case (.m_loginWithLinkedin__token_tokencompletion_completion(let lhsToken, let lhsCompletion), .m_loginWithLinkedin__token_tokencompletion_completion(let rhsToken, let rhsCompletion)):
        ...
        func intValue() -> Int {
            ...
            case let .m_loginWithLinkedin__token_tokencompletion_completion(p0, p1): return p0.intValue + p1.intValue
    ...
    public struct Verify {
        ...
        public static func loginWithLinkedin(token: Parameter<String>, completion: Parameter<(AuthResult<LoginResponse>) -> Void>) -> Verify { return Verify(method: .m_loginWithLinkedin__token_tokencompletion_completion(`token`, `completion`))}
    ...
    public struct Perform {
        ...
        public static func loginWithLinkedin(token: Parameter<String>, completion: Parameter<(AuthResult<LoginResponse>) -> Void>, perform: @escaping (String, @escaping ((AuthResult<LoginResponse>) -> Void)) -> Void) -> Perform {
            return Perform(method: .m_loginWithLinkedin__token_tokencompletion_completion(`token`, `completion`), performs: perform)
        }
...
// MARK: - LoginControllerTes
open class LoginControllerTesMock: LoginControllerTes, Mock {
    init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    open func test() {
        addInvocation(.m_test)
		let perform = methodPerformValue(.m_test) as? () -> Void
		perform?()
    }
    ...
    public struct Verify {
        ...
        public static func test() -> Verify { return Verify(method: .m_test)}
    }
    ...
    public struct Perform {
        ...
        public static func test(perform: @escaping () -> Void) -> Perform {
            return Perform(method: .m_test, performs: perform)
        }
    }
...
// MARK: - LoginOverviewInteractorProtocol
open class LoginOverviewInteractorProtocolMock: LoginOverviewInteractorProtocol, Mock {
    init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
...
// MARK: - LoginOverviewPresenterProtocol
open class LoginOverviewPresenterProtocolMock: LoginOverviewPresenterProtocol, Mock {
    init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
...
open class LoginOverviewViewControllerProtocolMock: LoginOverviewViewControllerProtocol, Mock {
    ...
    open func set(interactor: LoginOverviewInteractorProtocol) {
        addInvocation(.m_set__interactor_interactor(Parameter<LoginOverviewInteractorProtocol>.value(`interactor`)))
		let perform = methodPerformValue(.m_set__interactor_interactor(Parameter<LoginOverviewInteractorProtocol>.value(`interactor`))) as? (LoginOverviewInteractorProtocol) -> Void
		perform?(`interactor`)
    }
    ...
    fileprivate enum MethodType {
        case m_set__interactor_interactor(Parameter<LoginOverviewInteractorProtocol>)
    ...
    public struct Verify {
        ...
        public static func set(interactor: Parameter<LoginOverviewInteractorProtocol>) -> Verify { return Verify(method: .m_set__interactor_interactor(`interactor`))}
    ...
    public struct Perform {
        ...
        public static func set(interactor: Parameter<LoginOverviewInteractorProtocol>, perform: @escaping (LoginOverviewInteractorProtocol) -> Void) -> Perform {
...
// MARK: - LoginTest
open class LoginTestMock: LoginTest, Mock {
    init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
...
// MARK: - MoyaClientProtocol
open class MoyaClientProtocolMock: MoyaClientProtocol, Mock {
    init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    open func request<T:Codable>(_ target: Target, _ completion: @escaping RequestCompletion<T>) {
        addInvocation(.m_request__target_completion(Parameter<Target>.value(`target`), Parameter<RequestCompletion<T>>.any.wrapAsGeneric()))
		let perform = methodPerformValue(.m_request__target_completion(Parameter<Target>.value(`target`), Parameter<RequestCompletion<T>>.any.wrapAsGeneric())) as? (Target, @escaping RequestCompletion<T>) -> Void
		perform?(`target`, `completion`)
    }


    fileprivate enum MethodType {
        case m_request__target_completion(Parameter<Target>, Parameter<GenericAttribute>)

        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Bool {
            switch (lhs, rhs) {
            case (.m_request__target_completion(let lhsTarget, let lhsCompletion), .m_request__target_completion(let rhsTarget, let rhsCompletion)):
        ...
        func intValue() -> Int {
            switch self {
            case let .m_request__target_completion(p0, p1): return p0.intValue + p1.intValue
            }
        }
    }
    ...
    public struct Verify {
        ...
        public static func request<T>(_ target: Parameter<Target>, _ completion: Parameter<RequestCompletion<T>>) -> Verify where T:Codable { return Verify(method: .m_request__target_completion(`target`, `completion`.wrapAsGeneric()))}
    }
    ...
    public struct Perform {
        ...
        public static func request<T>(_ target: Parameter<Target>, _ completion: Parameter<RequestCompletion<T>>, perform: @escaping (Target, @escaping RequestCompletion<T>) -> Void) -> Perform where T:Codable {
            return Perform(method: .m_request__target_completion(`target`, `completion`.wrapAsGeneric()), performs: perform)
        }
    }
...
// MARK: - ProtocolNotToBeMocked
open class ProtocolNotToBeMockedMock: ProtocolNotToBeMocked, Mock {
    init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
...
// MARK: - SomeTestProtocol
open class SomeTestProtocolMock: SomeTestProtocol, Mock {
    init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
